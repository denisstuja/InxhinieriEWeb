...
<body>
    ...
    <div class="produktet">
        <div class="lista1">
            <div class="produkti">
                <a href="produkti.php" class="one">
                    <div class="photo"><img src="fotot/1_cc_caffelatte_r.webp" alt="" class="fotografia"></div>
                    <div class="emertimi"><p>Caffe Latte</p></div>
                </a>
            </div>
            <div class="produkti">
                <a href="produkti.php" class="one">
                    <div class="photo"><img src="fotot/1_cc_caffelatte_r.webp" alt="" class="fotografia"></div>
                    <div class="emertimi"><p>Cappuccino</p></div>
                </a>
            </div>
            <div class="produkti">
                <a href="produkti.php" class="one">
                    <div class="photo"><img src="fotot/1_cc_caffelatte_r.webp" alt="" class="fotografia"></div>
                    <div class="emertimi"><p>Flat White</p></div>
                </a>
            </div>
            <div class="produkti">
                <a href="produkti.php" class="one">
                    <div class="photo"><img src="fotot/1_cc_caffelatte_r.webp" alt="" class="fotografia"></div>
                    <div class="emertimi"><p>Americano</p></div>
                </a>
            </div>
        </div>
        <div class="lista2">
            <div class="produkti">
                <a href="produkti.php" class="one">
                    <div class="photo"><img src="fotot/1_cc_caffelatte_r.webp" alt="" class="fotografia"></div>
                    <div class="emertimi"><p>Caramel Macchiato</p></div>
                </a>
            </div>
            <div class="produkti">
                <a href="produkti.php" class="one">
                    <div class="photo"><img src="fotot/1_cc_caffelatte_r.webp" alt="" class="fotografia"></div>
                    <div class="emertimi"><p>Caffe Mocha</p></div>
                </a>
            </div>
            <div class="produkti">
                <a href="produkti.php" class="one">
                    <div class="photo"><img src="fotot/1_cc_caffelatte_r.webp" alt="" class="fotografia" ></div>
                    <div class="emertimi"><p>White Mocha</p></div>
                </a>
            </div>
            <div class="produkti">
                <a href="produkti.php" class="one">
                    <div class="photo"><img src="fotot/1_cc_caffelatte_r.webp" alt="" class="fotografia"></div>
                    <div class="emertimi"><p>Chocolate Cappuccino</p></div>
                </a>
            </div>
        </div>
    </div>
